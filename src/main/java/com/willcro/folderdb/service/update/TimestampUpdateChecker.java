...
/**
 * UpdateChecker that checks for updates based on the OS-reported update timestamp of the file. A
 * file is considered to be changed if the update timestamp is different the recorded state
 */
